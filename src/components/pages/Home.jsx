    ...
    <div>
      ...
      <main>
        ...
        <section id="about">
          ...
          />
          <p>
            Software Engineer with 2 years of experience in backend application
            development using Java, Spring Boot, REST APIs, PostgreSQL, Azure
            DevOps, and Microservices. Experienced in designing scalable backend
            solutions, collaborating with cross-functional teams, and delivering
        ...
        <section id="skills">
          ...
          <SkillCard
            category="Tools"
            skills={["Git", "Postman", "Swagger", "Jacoco", "Mockito"]}
          />
        </section>
